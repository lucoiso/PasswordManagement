...
public:
    ...
    Windows::Foundation::IAsyncAction ExportDataAsync(const PasswordManager::LoginDataFileType export_type) const;
    ...
    Windows::Foundation::IAsyncOperation<Windows::Storage::StorageFile> SavePasswordDataFileAsync(const PasswordManager::LoginDataFileType& export_mode) const;
