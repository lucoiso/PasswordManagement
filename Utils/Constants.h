...
constexpr wchar_t PASSWORD_DATA_LUPASS_HEADER[] = L"name,url,username,password,notes";
...
constexpr wchar_t PASSWORD_DATA_FIREFOX_HEADER[] = L"url,username,password,formSubmitURL,httpRealm,usernameField,passwordField";
